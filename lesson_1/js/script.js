...
document.querySelector('.three').innerHTML = '<h3>My name is Andrei.</h3>';
...
document.querySelector('.four').innerHTML += '<h4>What is your name?</h4><p>My name is Sergei.</p>';
...
div7.innerHTML = '<img src="https://cdn4.iconfinder.com/data/icons/food-and-drink-flat-gradient/32/cone_ice_cream_food_drink_sweet-512.png" alt="icecream">';
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.combination').innerHTML = x1 + x2;
